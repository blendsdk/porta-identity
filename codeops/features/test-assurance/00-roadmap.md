...
| RD-05   | Security risk-slice assurance                   | [RD-05](requirements/RD-05-security-risk-slice-assurance.md)                        | [test-assurance-program](plans/test-assurance-program/00-index.md)          | Executing | 🔄     | 2026-08-19 15:27 | consistency specification verified; live adapter next |
| ↳ DEF-3 | Advanced commit-boundary resilience campaign    | —                                                                                   | —                                                                           | Deferred  | ⏸️     | 2026-08-19 15:13 | pre/post-commit interruption and uncommitted timeout  |
