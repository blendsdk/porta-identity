...
4. **SDK/CLI/admin-UI consent-flag surfaces** — expose `requireConsent` through the SDK, the CLI,
   and the `porta admin` client form (deferred from DEF-21).
5. **DEF-23** — security-authority ruling that gates "fully production ready".
