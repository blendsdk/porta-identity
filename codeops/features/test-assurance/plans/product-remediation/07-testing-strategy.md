...
| ST-05 | Crash/restart after job claim and inject transient database/SMTP failures. | Expired leases are reclaimed once, retry schedule is bounded, no duplicate active artifact/delivery occurs, and terminal failure uses a closed reason. | 03-01; AR-5, AR-9 |
