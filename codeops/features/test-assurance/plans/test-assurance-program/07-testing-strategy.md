...
| `yarn assurance:compat --select <ST-69\|ST-70\|ST-71\|ST-72\|ST-73\|tenant-admin\|compatibility>`                             | built local SDK/CLI archives; clean consumer; isolated temporary `HOME`; healthy harness |                                                                                                          1,800 s | `compat/<selector>/`                | owns consumer/home/clients; real credential fingerprint unchanged on every outcome                                                                                                               |
