...
- [ ] **MR-01 — Monorepo root:** the repository root is private `@portaidentity/monorepo`, owns the active monorepo Yarn 1.x lockfile, and discovers the three packages plus retained private test infrastructure. (AR-07, AR-12, AR-17, AR-33)
...
- [ ] **MR-06 — Playground retirement:** unsupported playground applications and their dedicated tooling are absent from the active tree; unpublished technical guidance explains recovery from Git history. (AR-12)
...
- Selection, repair, or replacement of a future example application. (AR-12)
...
6. [ ] AC-06: unsupported playground applications and their dedicated tooling are absent from the active tree and workspace verification.
