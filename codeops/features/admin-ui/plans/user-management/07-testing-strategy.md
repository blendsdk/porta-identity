...
| ST-05 | Activate and deactivate lifecycle methods                                                                                                                                                                                                            | SDK sends the exact status-transition requests without reason payloads; suspend and manual lock methods are absent                                                        | RD-03 UM-09, AC-7                                        |
...
| ST-28 | Active/inactive/locked user opened                                                                        | Active exposes Deactivate, inactive exposes Activate, and locked exposes no lifecycle mutation                                                             | RD-03 UM-09, AC-7        |
