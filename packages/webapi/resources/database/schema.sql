...
DROP TABLE IF EXISTS sys_extension CASCADE;
...
ALTER TABLE sys_extension ADD COLUMN extension_id uuid NOT NULL DEFAULT uuid_generate_v4();
ALTER TABLE sys_extension ADD COLUMN name varchar NOT NULL;
ALTER TABLE sys_extension ADD COLUMN version varchar NOT NULL;
ALTER TABLE sys_extension ADD COLUMN description varchar NOT NULL;
ALTER TABLE sys_extension ADD COLUMN source varchar NOT NULL;
ALTER TABLE sys_extension ADD COLUMN options varchar  DEFAULT '{}';
ALTER TABLE sys_extension ADD COLUMN is_active boolean  DEFAULT false;
ALTER TABLE sys_extension ADD COLUMN date_created timestamp with time zone  DEFAULT now();
ALTER TABLE sys_extension ADD PRIMARY KEY (extension_id);
ALTER TABLE sys_extension ADD UNIQUE (name,version);
