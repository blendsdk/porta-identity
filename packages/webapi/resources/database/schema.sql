...
ALTER TABLE sys_secret ADD COLUMN id serial NOT NULL;
ALTER TABLE sys_secret ADD COLUMN secret varchar NOT NULL;
ALTER TABLE sys_secret ADD COLUMN description varchar;
ALTER TABLE sys_secret ADD COLUMN valid_from integer NOT NULL;
ALTER TABLE sys_secret ADD COLUMN valid_to integer NOT NULL;
...
ALTER TABLE sys_client ADD COLUMN id serial NOT NULL;
