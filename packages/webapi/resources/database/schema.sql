...
ALTER TABLE sys_secret ADD FOREIGN KEY (client_id) REFERENCES sys_client (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE INDEX gin_sys_secret_client_id ON sys_secret USING GIN (client_id);
