...
export const routeDefinitions: {
	...
	initialize: { delete_tenant: IRouteBase; create_tenant: IRouteBase; initialize: IRouteBase };
	...
	admin: {
		change_account_state: IRouteBase;
		create_account: IRouteBase;
		create_application: IRouteBase;
		create_client: IRouteBase;
	};
} = {
	blend: {
	...
	initialize: {
		delete_tenant: { id: "delete_tenant", method: "post", url: "/api/initialize/tenant/delete", public: false },
	...
	admin: {
		...
		create_account: { id: "create_account", method: "post", url: "/api/admin/:tenant/account/create", public: false },
		create_application: {
		...
		create_client: { id: "create_client", method: "post", url: "/api/admin/:tenant/client/create", public: false }
	}
};
