...
export async function generateKeyPareAndCertificate(name: string) {
    const alg = {
...
export function parseSeparatedTokens(strTokens: string, caseSensitive?: boolean): IDictionaryOf<boolean> {
