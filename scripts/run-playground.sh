...
echo "    SPA: pick a profile from the 'Login Method Demo' card"
echo "    BFF: restart with BFF_CLIENT_PROFILE=<key> to switch client"
echo "         e.g. BFF_CLIENT_PROFILE=password yarn workspace playground-bff dev"
echo "              BFF_CLIENT_PROFILE=magic    yarn workspace playground-bff dev"
echo "    BFF profile catalog: http://localhost:4001/debug/login-methods"
echo ""
